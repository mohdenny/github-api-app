    ...
    return (
        <Fragment>
            <div className="flex flex-col space-y-4 px-2 justify-center items-center">
                ...
                {   
                    state.visible < repos.length && <button onClick={loadMore} type="button" className="load-more px-2 py-1 mt-2 rounded-xl border-2 border-gray-300 hover:bg-gray-300">Load More</button>
                }
            </div>
        </Fragment>
    )
